...
jQuery(document).ready(function(){
	// Locale files are loaded asynchronously (synchronous XHR is
	// forbidden in extension pages since Chrome 89); localize the page
	// only after the messages are available.
	if (chrome.i18n._loadL10nDataAsync !== undefined) {
		chrome.i18n._loadL10nDataAsync(localizePage);
	} else {
		localizePage();
	}
});
